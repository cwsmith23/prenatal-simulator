...
def run_simulation(params):
    ...
    for month in range(1, months + 1):
        ...
        records.append({
            ...
            "S1 to Ship": ship_mon[1] + ship_pre[1],
            "S2 to Ship": ship_mon[2] + ship_pre[2],
            "S3 to Ship": ship_mon[3] + ship_pre[3],
            "Inv S1": inventory[1],
            "Inv S2": inventory[2],
            "Inv S3": inventory[3],
            "Reorder": reorder,
            ...
            "Rev Monthly Subs": round(rev_mon, 2),
            "Rev Prepaid Members": round(rev_pre, 2),
            "Total Revenue": round(total_rev, 2),
            "CAC": round(cac, 2),
            "Shipping Cost": round(ship_cost, 2),
            ...
            "Deferred Liabilities": round(deferred, 2)
        })
