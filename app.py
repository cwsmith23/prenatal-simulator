...
rqty          = st.sidebar.number_input("Reorder Quantity (#)", 0, 25000, 50)
rcost1        = st.sidebar.number_input("Reorder Cost Stage 1 ($)", 0, 1000000, 100)
rcost2        = st.sidebar.number_input("Reorder Cost Stage 2 ($)", 0, 1000000, 100)
rcost3        = st.sidebar.number_input("Reorder Cost Stage 3 ($)", 0, 1000000, 100)
ship_cost_pkg = st.sidebar.number_input("Shipping Cost per Pack ($)", 0.0, 50.0, 5.0, format="%.2f")
inv1          = st.sidebar.number_input("Initial Inv Stage 1 (#)", 0, 25000, 50)
inv2          = st.sidebar.number_input("Initial Inv Stage 2 (#)", 0, 25000, 50)
inv3          = st.sidebar.number_input("Initial Inv Stage 3 (#)", 0, 25000, 50)
